        ...
        <SafeAreaView style={{ backgroundColor: Appcolor.txt }}>
            <ImageBackground source={Appimg.goldborder} imageStyle={{ resizeMode: "stretch" }} style={[styles.main, { alignItems: "center", justifyContent: "center" }]}>
                ...
                <View style={{ width: "100%", alignItems: 'center', flex: 0.8, justifyContent: "flex-end" }}>
                    <Btn title={en?.login} transparent={Appcolor.whiteop} styleMain={{ marginTop: 26 }} txtStyle={{ fontSize: 17.6, color: Appcolor.txt }} onPress={() => navigation.navigate("LoginS")} />
                    <Btn title={en?.signup} transparent2={Appcolor.primop} twhite transparent={Appcolor.yellowop} styleMain={{ marginTop: 16 }} txtStyle={{ fontSize: 17.6 }} onPress={() => navigation.navigate("SignupS")} />
                </View>
            </ImageBackground>
        </SafeAreaView>
    )
