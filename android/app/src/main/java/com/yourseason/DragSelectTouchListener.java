...
public class DragSelectTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    private final SelectDselectImage selectDselectImage;
    private final Context context;
    private final List<Photo> photos;
    private final GalleryPhotoAdapter adapter;
    ...
    public DragSelectTouchListener(RecyclerView recyclerView, SelectDselectImage selectDselectImage, Context context, List<Photo> photos, GalleryPhotoAdapter adapter) {
    ...
    private void handleDragSelection(int position) {
        ...
        boolean isOneSelected = adapter.photos.stream().anyMatch(Photo::isSelected);
