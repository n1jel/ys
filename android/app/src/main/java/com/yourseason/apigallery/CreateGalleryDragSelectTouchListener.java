...
public class CreateGalleryDragSelectTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    private final SelectDselectImageWithApi selectDselectImage;
    private final Context context;
    private final List<CreateGalleryData.Datum> photos;
    private final CreateGalleryWithApiAdapter adapter;
    ...
    public CreateGalleryDragSelectTouchListener(RecyclerView recyclerView, SelectDselectImageWithApi selectDselectImage, Context context, List<CreateGalleryData.Datum> photos, CreateGalleryWithApiAdapter adapter) {
    ...
    private void handleDragSelection(int position) {
        ...
        boolean isOneSelected = adapter.photos.stream().anyMatch(CreateGalleryData.Datum::isSelected);
            ...
            try {
                ...
                if (position != RecyclerView.NO_POSITION && position != lastSelectedPosition) {
                    ...
                    for (int i = start; i <= end; i++) {
                        ...
                        CreateGalleryData.Datum photo = photos.get(i);
